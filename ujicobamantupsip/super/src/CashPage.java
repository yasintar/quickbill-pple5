...
import MyFrames.FormBill;
import MyFrames.SearchProduct;
...
public class CashPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Quick Bill");
        setPreferredSize(new java.awt.Dimension(373, 301));
        ...
        SearchProduct.setText("Search Item");
    ...
    private void SearchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchButtonActionPerformed
        SearchBill bills=new SearchBill();
        this.desk.add(bills);
    ...
    private void SearchProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchProductActionPerformed
        SearchProduct pro=new SearchProduct();
        this.desk.add(pro);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CashPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
